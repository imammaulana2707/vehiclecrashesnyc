...
st.markdown("This Application is Dashboard That Can be Used to Analyze Motor Vehicle Crashes in New York City")
...
st.subheader("Breakdown by munite between %i:00 and %i:00" % (hour, (hour + 1) %24))
filtered = data[
